...
const DashBoard = props => {
  ...
  return (
    <div className={'info-location'}>
      ...
      <div>
        <p>Температура:</p> <p>{current.temperature}</p>
      </div>
      <div>
        <p>Сила ветра:</p> <p>{current.wind_speed}км/ч</p>
      </div>
      <div>
        <p>Направление ветра:</p> <p>{current.wind_dir}</p>
      </div>
      <div>
        <p>Давление:</p> <p>{current.pressure} MB</p>
      </div>
      <div>
        <p>Влажность:</p> <p>{current.humidity}%</p>
      </div>
      <div>
