...
import { changeSearch, clickLocation, fetchLocation } from '../../redux/actionCreators.jsx';
...
export default connect(mapStateToProps, { changeSearch, clickLocation, fetchLocation })(
